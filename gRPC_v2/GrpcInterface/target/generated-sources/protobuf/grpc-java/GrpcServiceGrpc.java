...
public final class GrpcServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ByteRequest,
      ByteResponse> getStreamToClientMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "streamToClient",
      requestType = ByteRequest.class,
      responseType = ByteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ByteRequest,
      ByteResponse> getStreamToClientMethod() {
    io.grpc.MethodDescriptor<ByteRequest, ByteResponse> getStreamToClientMethod;
    if ((getStreamToClientMethod = GrpcServiceGrpc.getStreamToClientMethod) == null) {
      synchronized (GrpcServiceGrpc.class) {
        if ((getStreamToClientMethod = GrpcServiceGrpc.getStreamToClientMethod) == null) {
          GrpcServiceGrpc.getStreamToClientMethod = getStreamToClientMethod =
              io.grpc.MethodDescriptor.<ByteRequest, ByteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "streamToClient"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ByteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ByteResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GrpcServiceMethodDescriptorSupplier("streamToClient"))
              .build();
        }
      }
    }
    return getStreamToClientMethod;
  }
  ...
  public static abstract class GrpcServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void streamToClient(ByteRequest request,
        io.grpc.stub.StreamObserver<ByteResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getStreamToClientMethod(), responseObserver);
    }
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                ByteRequest,
                ByteResponse>(
                  this, METHODID_STREAM_TO_CLIENT)))
          .build();
    }
  }
  ...
  public static final class GrpcServiceStub extends io.grpc.stub.AbstractAsyncStub<GrpcServiceStub> {
    ...
    public void streamToClient(ByteRequest request,
        io.grpc.stub.StreamObserver<ByteResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getStreamToClientMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GrpcServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GrpcServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<ByteResponse> streamToClient(
        ByteRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
          getChannel(), getStreamToClientMethod(), getCallOptions(), request);
    }
  }
  ...
  private static final int METHODID_STREAM_TO_CLIENT = 3;
      ...
      switch (methodId) {
        ...
        case METHODID_STREAM_FIB:
          serviceImpl.streamFib((fibRequest) request,
              (io.grpc.stub.StreamObserver<fibResponse>) responseObserver);
          break;
        case METHODID_STREAM_TO_CLIENT:
          serviceImpl.streamToClient((ByteRequest) request,
              (io.grpc.stub.StreamObserver<ByteResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (GrpcServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getStreamToClientMethod())
              .build();
        }
      }
    }
